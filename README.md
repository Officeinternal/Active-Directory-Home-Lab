...
*Troubleshooting: If you run into this issue, make sure to press a key when the text is displayed on the screen or you will receive this pop-up
![Screenshot 16](screenshots/16.png)

If all is set properly, you'll continue to the installation
